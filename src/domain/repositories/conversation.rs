...
pub trait ConversationRepository {
    ...
    async fn put(&mut self, conversation: Conversation) -> Result<Conversation, RepositoryError>;

    async fn delete(&mut self, id: ConversationId) -> Result<Conversation, RepositoryError>;
